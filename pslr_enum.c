...
const char *pslr_color_space_str[PSLR_COLOR_SPACE_MAX] = {"sRGB", "AdobeRGB"};

const char *pslr_af_mode_str[PSLR_AF_MODE_MAX] = {"MF", "AF.S", "AF.C", "AF.A"};

const char *pslr_ae_metering_str[PSLR_AE_METERING_MAX] = {"Multi", "Center", "Spot"};

const char *pslr_flash_mode_str[PSLR_FLASH_MODE_MAX] = {
    "Manual",          "Manual-RedEye", "Slow", "Slow-RedEye", "TrailingCurtain", "Auto", "Auto-RedEye",
    "TrailingCurtain", // maybe in manual mode??
    "Wireless"};

const char *pslr_drive_mode_str[PSLR_DRIVE_MODE_MAX] = {"Single", // Bracketing also returns Single
                                                        "Continuous-HI", "SelfTimer-12", "SelfTimer-2",
                                                        "Remote",        "Remote-3",     "Continuous-LO"};

const char *pslr_af_point_sel_str[PSLR_AF_POINT_SEL_MAX] = {"Auto-5", "Select", "Spot", "Auto-11"};

const char *pslr_jpeg_image_tone_str[PSLR_JPEG_IMAGE_TONE_MAX] = {
    "Natural",    "Bright", "Portrait",     "Landscape",    "Vibrant",
    "Monochrome", "Muted",  "ReversalFilm", "BleachBypass", "Radiant"};

const char *pslr_white_balance_mode_str[PSLR_WHITE_BALANCE_MODE_MAX] = {
    "Auto",          "Daylight", "Shade", "Cloudy", "Fluorescent_D", "Fluorescent_N",
    "Fluorescent_W", "Tungsten", "Flash", "Manual",
    "0x0A", // ??
    "0x0B", // ??
...
const char *pslr_custom_ev_steps_str[PSLR_CUSTOM_EV_STEPS_MAX] = {"1/2", "1/3"};

const char *pslr_raw_format_str[PSLR_RAW_FORMAT_MAX] = {"PEF", "DNG"};

const char *pslr_exposure_submode_str[PSLR_EXPOSURE_SUBMODE_MAX] = {
    "NONE",     "HISPEED",    "DOF",         "MTF",    "STANDARD",
    "PORTRAIT", "LANDSCAPE",  "MACRO",       "SPORT",  "NIGHTSCENEPORTRAIT",
    "NOFLASH",  "NIGHTSCENE", "SURFANDSNOW", "TEXT",   "SUNSET",
    "KIDS",     "PET",        "CANDLELIGHT", "MUSEUM", "FOOD",
    "STAGE",    "NIGHTSNAP",  "SWALLOWDOF"};
...
const char *get_pslr_color_space_str(pslr_color_space_t value) { return pslr_color_space_str[value]; }
...
const char *get_pslr_af_mode_str(pslr_af_mode_t value) { return pslr_af_mode_str[value]; }
...
const char *get_pslr_ae_metering_str(pslr_ae_metering_t value) { return pslr_ae_metering_str[value]; }
...
const char *get_pslr_flash_mode_str(pslr_flash_mode_t value) { return pslr_flash_mode_str[value]; }
...
const char *get_pslr_drive_mode_str(pslr_drive_mode_t value) { return pslr_drive_mode_str[value]; }
...
const char *get_pslr_af_point_sel_str(pslr_af_point_sel_t value) { return pslr_af_point_sel_str[value]; }

pslr_jpeg_image_tone_t get_pslr_jpeg_image_tone(char *str) {
    return find_in_array(pslr_jpeg_image_tone_str,
                         sizeof(pslr_jpeg_image_tone_str) / sizeof(pslr_jpeg_image_tone_str[0]), str);
}

const char *get_pslr_jpeg_image_tone_str(pslr_jpeg_image_tone_t value) { return pslr_jpeg_image_tone_str[value]; }

pslr_white_balance_mode_t get_pslr_white_balance_mode(char *str) {
    return find_in_array(pslr_white_balance_mode_str,
                         sizeof(pslr_white_balance_mode_str) / sizeof(pslr_white_balance_mode_str[0]), str);
}
...
const char *get_pslr_custom_ev_steps_str(pslr_custom_ev_steps_t value) { return pslr_custom_ev_steps_str[value]; }

const char *get_pslr_raw_format_str(pslr_raw_format_t value) { return pslr_raw_format_str[value]; }

const char *get_pslr_exposure_submode_str(pslr_exposure_submode_t value) { return pslr_exposure_submode_str[value]; }
